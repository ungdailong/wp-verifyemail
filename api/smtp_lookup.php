 ...
 */  
  ...
  * Host Name of sender 
  */  
 var $from_domain = 'verify-email.org';  
 ...
 */  
 ...
 foreach($this->domains as $domain=>$users) {  
  ...
  $mxs = array();  
    //$mxs['mta-v1.biz.mail.vip.sk1.yahoo.com'] = 0;
   // retrieve SMTP Server via MX query on domain  
  list($hosts, $mxweights) = $this->queryMX($domain);  
  
  //$hosts[] = 'mta1018.biz.mail.mud.yahoo.com';
  //print_r($hosts);die();
...
//$stmp = new SMTP_validateEmail(array('ungdailong@gmail.com'));
//$checkEmail = new SMTP_validateEmail(array('hotro@huyenvu.vn'));
//$check = $checkEmail->validate(array('hotro@huyenvu.vn'));
//print_r($checkEmail -> $domains);
?>