...
function infoway_reset_options($options,$page = ''){
	...
	//When Theme Options page is reset - Add the infoway_options option
	if($page == 'optionsframework'){
		infoway_delete_option( 'infoway_options' );
	}
}
/*-----------------------------------------------------------------------------------*/
...
function infoway_load_only() {
	add_action('admin_head', 'infoway_admin_head');
